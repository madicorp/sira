                        ...
                        m("a.thumb-video__link.js-modal-video[href='" + id + "']",
                            [
                                ...
                                m("span.thumb-video__button",
                                    m("svg[height='29px'][version='1.1'][viewBox='0 0 415.346 415.346'][width='21px'][x='0px'][xml:space='preserve'][xmlns='http://www.w3.org/2000/svg'][xmlns:xlink='http://www.w3.org/1999/xlink'][y='0px']", {style: {"enable-background": "new 0 0 415.346 415.346"}},
                                        m("g",
